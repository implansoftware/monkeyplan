...
const menuItems = {
  admin: [
    ...
    { title: "Dispositivi", url: "/admin/smartphone-catalog", icon: Smartphone, group: "Magazzino" },
  ...
  reseller: [
    ...
    { title: "Dispositivi", url: "/reseller/smartphone-catalog", icon: Smartphone, group: "Magazzino" },
  ...
  repair_center: [
    ...
    { title: "Dispositivi", url: "/repair-center/smartphone-catalog", icon: Smartphone, group: "Cataloghi" },
