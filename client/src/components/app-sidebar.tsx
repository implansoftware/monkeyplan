...
const menuItems = {
  admin: [
    ...
    { title: "Interscambio", url: "/admin/transfer-requests", icon: Inbox, group: "Magazzino" },
  ...
  reseller: [
    ...
    { title: "Richieste Ricevute", url: "/reseller/incoming-transfer-requests", icon: Inbox, group: "Magazzino" },
    { title: "Richieste Inviate", url: "/reseller/sub-transfer-requests", icon: Send, group: "Magazzino" },
  ...
  repair_center: [
    ...
    { title: "Interscambio", url: "/repair-center/transfer-requests", icon: Send, group: "Acquisti B2B" },
    ...
    <Sidebar>
      <SidebarHeader className="p-4 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold">Monkey Plan <span className="text-red-500">Beta v.22</span></h2>
              ...
              <Collapsible open={isOpen} onOpenChange={(open) => setGroupOpen(group, open)}>
                <CollapsibleTrigger asChild>
                  ...
                  >
                    ...
                    {group === "Magazzino" && pendingTransferRequestsCount > 0 && !isOpen && (
                      <span 
