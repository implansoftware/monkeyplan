...
const menuItems = {
  admin: [
    ...
    { title: "Utility", url: "/admin/utility", icon: Zap, group: "Centri & Riparazioni" },
    { title: "Fornitori Utility", url: "/admin/utility/suppliers", icon: Phone, group: "Centri & Riparazioni" },
    { title: "Listino Servizi", url: "/admin/utility/services", icon: Package, group: "Centri & Riparazioni" },
    { title: "Pratiche", url: "/admin/utility/practices", icon: FileCheck, group: "Centri & Riparazioni" },
    { title: "Compensi", url: "/admin/utility/commissions", icon: Coins, group: "Centri & Riparazioni" },
    { title: "Report Utility", url: "/admin/utility/reports", icon: PieChart, group: "Centri & Riparazioni" },
  ...
  reseller: [
    ...
    { title: "Utility", url: "/reseller/utility", icon: Zap, group: "Centri & Riparazioni" },
    { title: "Fornitori Utility", url: "/reseller/utility/suppliers", icon: Phone, group: "Centri & Riparazioni" },
    { title: "Listino Servizi", url: "/reseller/utility/services", icon: Package, group: "Centri & Riparazioni" },
    { title: "Pratiche", url: "/reseller/utility/practices", icon: FileCheck, group: "Centri & Riparazioni" },
    { title: "Compensi", url: "/reseller/utility/commissions", icon: Coins, group: "Centri & Riparazioni" },
    { title: "Report Utility", url: "/reseller/utility/reports", icon: PieChart, group: "Centri & Riparazioni" },
