...
const menuItems = {
  admin: [
    ...
    { title: "Catalogo Interventi", url: "/admin/service-catalog", icon: Receipt, group: "Centri" },
  ...
  reseller: [
    ...
    { title: "Catalogo Interventi", url: "/reseller/service-catalog", icon: Receipt, group: "Riparazioni" },
