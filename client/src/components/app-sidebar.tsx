...
const menuItems = {
  admin: [
    ...
    { title: "Prodotti", url: "/admin/products", icon: ShoppingCart, group: "Magazzino & Fornitori" },
  ...
  reseller: [
    ...
    { title: "Prodotti", url: "/reseller/products", icon: Package, group: "Magazzino & Fornitori" },
