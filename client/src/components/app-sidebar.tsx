...
const menuItems = {
  admin: [
    ...
    { title: "Magazzino", url: "/admin/warehouses", icon: Warehouse, group: "Magazzino & Fornitori" },
    ...
    { title: "Fornitori", url: "/admin/suppliers", icon: Building2, group: "Magazzino & Fornitori" },
  ...
  reseller: [
    ...
    { title: "Ordini Vendita", url: "/reseller/sales-orders", icon: ShoppingCart, group: "E-commerce" },
