...
const menuItems = {
  admin: [
    ...
    { title: "Catalogo Dispositivi", url: "/admin/device-catalog", icon: Package, group: "Magazzino" },
    { title: "Carico Magazzino", url: "/admin/parts-load", icon: ClipboardList, group: "Magazzino" },
  ...
  reseller: [
    ...
    { title: "Carico Magazzino", url: "/reseller/parts-load", icon: ClipboardList, group: "Magazzino" },
