            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Modelli Compatibili</FormLabel>
                      <FormControl>
                        <Textarea 
                          placeholder="es. iPhone 14, iPhone 14 Pro, iPhone 14 Pro Max..." 
                          {...field} 
                          data-testid="textarea-part-models"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Descrizione Tecnica</FormLabel>
                      <FormControl>
                        <Textarea 
                          placeholder="Note tecniche sul ricambio..." 
                          {...field} 
                  ...
                  <CardContent className="p-4 space-y-3">
                    ...
                    <div className="pt-4 border-t">
                      ...
                      {values.compatibleModels && (
                        <p className="text-sm mt-1 text-muted-foreground">{values.compatibleModels}</p>
                      )}
                    </div>
