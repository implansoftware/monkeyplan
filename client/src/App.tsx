...
import AdminCourtesyPhones from "@/pages/admin/courtesy-phones";
...
import ResellerRepairCenterDetail from "@/pages/reseller/repair-center-detail";
...
import ResellerCourtesyPhones from "@/pages/reseller/courtesy-phones";
...
import RepairCenterCourtesyPhones from "@/pages/repair-center/courtesy-phones";
...
function Router() {
  return (
    <Switch>
      ...
      <ProtectedRoute path="/admin/courtesy-phones" component={AdminCourtesyPhones} />
      ...
      <ProtectedRoute path="/admin/warranties" component={AdminWarranties} />
      ...
      <ProtectedRoute path="/reseller/repair-centers/:id" component={ResellerRepairCenterDetail} allowedRoles={["reseller", "reseller_staff", "sub_reseller"]} />
      ...
      <ProtectedRoute path="/reseller/courtesy-phones" component={ResellerCourtesyPhones} allowedRoles={["reseller", "reseller_staff", "sub_reseller"]} />
      ...
      <ProtectedRoute path="/reseller/warranty-products" component={ResellerWarrantyProducts} allowedRoles={["reseller", "reseller_staff", "sub_reseller"]} />
      <ProtectedRoute path="/reseller/reports" component={ResellerReports} allowedRoles={["reseller", "reseller_staff", "sub_reseller"]} />
      <ProtectedRoute path="/reseller/warranty-analytics" component={ResellerWarrantyAnalytics} allowedRoles={["reseller", "reseller_staff", "sub_reseller"]} />
      <ProtectedRoute path="/reseller/warranties/:id" component={ResellerWarrantyDetail} allowedRoles={["reseller", "reseller_staff", "sub_reseller"]} />
      <ProtectedRoute path="/reseller/warranties" component={ResellerWarranties} allowedRoles={["reseller", "reseller_staff", "sub_reseller"]} />
      ...
      <ProtectedRoute path="/reseller/integrations" component={ResellerIntegrations} allowedRoles={["reseller", "sub_reseller"]} />
      ...
      <ProtectedRoute path="/reseller/remote-requests" component={ResellerRemoteRequests} allowedRoles={["reseller", "reseller_staff", "sub_reseller"]} />
      ...
      {/* Reseller HR routes */}
      <ProtectedRoute path="/reseller/hr/attendance" component={ResellerHrAttendance} allowedRoles={["reseller", "sub_reseller"]} />
      <ProtectedRoute path="/reseller/hr/leave-requests" component={ResellerHrLeaveRequests} allowedRoles={["reseller", "sub_reseller"]} />
      <ProtectedRoute path="/reseller/hr/work-profiles" component={ResellerHrWorkProfiles} allowedRoles={["reseller", "sub_reseller"]} />
      <ProtectedRoute path="/reseller/hr/expenses" component={ResellerHrExpenses} allowedRoles={["reseller", "sub_reseller"]} />
      <ProtectedRoute path="/reseller/hr/sick-leave" component={ResellerHrSickLeave} allowedRoles={["reseller", "sub_reseller"]} />
      <ProtectedRoute path="/reseller/hr/calendar" component={ResellerHrCalendar} allowedRoles={["reseller", "sub_reseller"]} />
      <ProtectedRoute path="/reseller/hr" component={ResellerHrDashboard} allowedRoles={["reseller", "sub_reseller"]} />
      ...
      <ProtectedRoute path="/repair-center/courtesy-phones" component={RepairCenterCourtesyPhones} />
