        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl font-bold">Profili Orario</h1>
                <p className="text-muted-foreground">Configurazione orari di lavoro</p>
              </div>
            </div>
          </div>
          <div className="flex gap-2">
            ...
            <Button onClick={() => { setEditingProfile(null); setNewProfile({ name: "", description: "", weeklyHours: "40", dailyHours: "8" }); setDialogOpen(true); }}>
