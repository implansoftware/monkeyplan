    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold" data-testid="text-page-title">Catalogo Accessori</h1>
            <p className="text-muted-foreground">Accessori disponibili dal tuo rivenditore</p>
          </div>
        </div>
        {cartItemCount > 0 && (
