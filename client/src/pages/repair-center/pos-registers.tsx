...
export default function PosRegistersPage() {
  ...
  const createMutation = useMutation({
    mutationFn: async (data: RegisterFormData) => {
      return apiRequest("POST", "/api/repair-center/pos/registers", data);
    },
    onSuccess: () => {
  ...
  const invalidatePosQueries = () => {
    ...
    queryClient.invalidateQueries({ queryKey: ["/api/repair-center/pos/session/last"] });
    queryClient.invalidateQueries({ queryKey: ["/api/repair-center/pos/sessions"] });
    queryClient.invalidateQueries({ queryKey: ["/api/repair-center/pos/transactions"] });
    queryClient.invalidateQueries({ queryKey: ["/api/repair-center/pos/cart"] });
  };
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id: string) => {
      return apiRequest("DELETE", `/api/repair-center/pos/registers/${id}`);
    },
    onSuccess: () => {
      invalidatePosQueries();
