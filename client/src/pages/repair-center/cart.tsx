    ...
    <div className="p-6 space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold" data-testid="text-page-title">Carrello B2B</h1>
            <p className="text-muted-foreground">Gestisci i prodotti nel tuo carrello e completa l'ordine</p>
          </div>
        </div>
        <div className="flex gap-2">
          ...
          {cart.length > 0 && (
            <Button variant="destructive" onClick={clearCart} data-testid="button-clear-cart">
