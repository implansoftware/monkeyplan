...
import { 
  ...
  Clock, Truck, Receipt, DollarSign
} from "lucide-react";
...
export default function ResellerSalesReturns() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold" data-testid="page-title">Gestione Resi</h1>
        <p className="text-muted-foreground">Gestisci le richieste di reso dei clienti</p>
      </div>
