      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-primary/5 via-primary/10 to-slate-100 dark:from-primary/10 dark:via-primary/5 dark:to-slate-900 p-6 border">
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight">I Miei Resi B2B</h1>
              <p className="text-sm text-muted-foreground">Gestisci le tue richieste di reso per ordini B2B</p>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="bg-blue-50 dark:bg-blue-950/30 p-3 rounded-lg space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedReturn.shippingLabelPath && (
                        ...
                        >
                          <a 
                            href={`/api/reseller/b2b-returns/${selectedReturn.id}/label`}
                      ...
                      {selectedReturn.ddtPath && (
                        ...
                        >
                          <a 
                            href={`/api/reseller/b2b-returns/${selectedReturn.id}/ddt`}
