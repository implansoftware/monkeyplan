  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="text-network-warehouses-title">Magazzini Rete</h1>
          <p className="text-muted-foreground">
            Gestisci i magazzini della tua rete: sub-rivenditori e centri di riparazione
          </p>
        </div>
      </div>
