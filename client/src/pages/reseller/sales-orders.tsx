  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-bold" data-testid="text-sales-orders-title">Ordini di vendita</h1>
          <p className="text-muted-foreground">Gestisci gli ordini dei tuoi clienti</p>
        </div>
      </div>
