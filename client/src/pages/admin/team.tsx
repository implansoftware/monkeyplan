  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold mb-2">Gestione Team Admin</h1>
          <p className="text-muted-foreground">
            Aggiungi collaboratori admin con permessi granulari per modulo
          </p>
        </div>
        <Button onClick={openCreateDialog} data-testid="button-new-admin-staff">
