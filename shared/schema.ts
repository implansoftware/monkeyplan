...
// Enums
export const userRoleEnum = pgEnum("user_role", ["admin", "admin_staff", "reseller", "reseller_staff", "repair_center", "repair_center_staff", "customer"]);
...
export const posTransactionItems = pgTable("pos_transaction_items", {
  ...
  // Prodotto (nullable per prodotti temporanei o servizi)
  productId: varchar("product_id").references(() => products.id),
  productName: text("product_name").notNull(),
  productSku: varchar("product_sku", { length: 100 }),
  productBarcode: varchar("product_barcode", { length: 100 }),
  
  // Servizio dal catalogo interventi (alternativo a productId)
...
export const paymentConfigurations = pgTable("payment_configurations", {
  ...
  stripeSecretKey: varchar("stripe_secret_key", { length: 500 }), // sk_live_xxxxx or sk_test_xxxxx (encrypted)
